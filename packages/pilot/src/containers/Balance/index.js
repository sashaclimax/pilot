...
const isSameDay = dates =>
  moment(dates).isSame(moment().add(1, 'day'), 'day')
          ...
          <ModalContent>
            {
              isValidDateAndSameDay(anticipationCancel)
                ?
                  <Fragment>
                    <span>
                      {t('cancel_pending_request_text_today.text')}
                      <br />
                      <br />
                      {t('cancel_pending_request_text_today.confirm')}
                    </span>
                  </Fragment>
...
Balance.propTypes = {
  ...
  modalConfirmOpened: PropTypes.bool.isRequired,
  onAnticipationClick: PropTypes.func.isRequired,
  onCancelRequestClick: PropTypes.func,
  onCancelRequestClose: PropTypes.func.isRequired,
  onConfirmCancelPendingRequest: PropTypes.func.isRequired,
